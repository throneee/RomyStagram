...
const SavedPostOfUser = ({ posts, postsCount }) => {
    // ************************************* State *************************************
    ...
    if (postsCount === 0) {
        body = (
            <div className='no-post d-flex flex-column align-items-center py-3 w-100 mt-3'>
                <div className='rounded-circle d-flex justify-content-center align-items-center'>
                    <i className='bi bi-camera text-secondary'></i>
                </div>

                <h4 className='mb-0 mt-2 text-secondary'>No Posts Saved</h4>
            </div>
        );
    } else {
        body = (
